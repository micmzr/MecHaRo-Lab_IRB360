...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_base = os.path.join(
        get_package_share_directory("irb360"), "rviz"
    )
    ...
    irb360_joint_publisher = Node(
        package='irb360_fk_joints_publisher',
        executable='irb360_fk_joints_publisher',
        name='irb360_fk_joints_publisher',
        output='screen')
    ...
    nodes_to_start = [move_group_node, irb360_joint_publisher, static_tf_node, robot_state_pub_node, rviz_node]
